...
<div class="row d-flex">       
    ...
    <div class="col-md-6 p-2">
        <div class="form-group ">
            ...
            <input class="form-control" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" placeholder="Tên tiêu đề" name="name" type="text" id="name" value="{{$managecategorys->name}}">
        </div>
        <div class="form-group ">
            <label for="slug">URL</label>
            <input class="form-control" placeholder="URL" name="slug" type="text" id="slug-text" value="{{$managecategorys->slug}}">
        </div>
    </div>
</div>
