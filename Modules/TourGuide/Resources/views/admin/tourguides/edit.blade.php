...
@section('content-header')
    <h1>
        {{ trans('tourguide::tourguides.title.edit tourguide') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.tourguide.tourguide.index') }}">{{ trans('tourguide::tourguides.title.tourguides') }}</a></li>
        <li class="active">{{ trans('tourguide::tourguides.title.edit tourguide') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.tourguide.tourguide.update', $tourguide->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('tourguide::admin.tourguides.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
