...
<div class = "row">
    ...
    <div class ="col-sm-6">
        ...
        <div class="form-group ">
            ...
            <input type="text" class="form-control" value="0" step=".01" data-variavel="price"   >
        </div>
        <div class="form-group ">
            <label for="discount">Giảm giá</label>
            <!-- <input placeholder="Giảm giá" name="discount" type="number" value="0" step=".01" id="discount" class="input-calc form-control"> -->
            <input type="text" class="form-control" data-variavel="discount" value="0" step=".01">
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control" data-formula="#price# - #discount#" step=".01" value="0" readonly>
        </div>
